...
//	
//	protected Quest			owner;
//	protected bool			isComplete = false;
//	protected ObjectiveBehaviour<StoreT,SentT>	behaviour;
//	
//	public Objective( string name, string msgName, Quest o ) {
//		Name = name;
//		notificationMessage = msgName;
//		owner = o;
//	}
//	
//	public Objective( string name, string msgName, Quest o, ObjectiveBehaviour<StoreT,SentT> ob ) {
//		Name = name;
//		notificationMessage = msgName;
//		behaviour = ob;
//		owner = o;
...
//	public ObjectiveSimple( string name, string msgName, Quest o) : base (name,msgName,o) {
//	}
//}
//
///// <summary>
...
//	public ObjectiveStoreInt( string name, string msgName, Quest o) : base (name,msgName,o) {
//	}
...
//	public ObjectiveStoreFloat( string name, string msgName, Quest o) : base (name,msgName,o) {
//	}
//	public override float Progress {
//		get {
