...
public class QuestSurveyArea : Quest
{
	...
	{
		AddObjective (new ObjectiveSurveyArea ("Survey Land", 10));
...
public class QuestProtectArea : Quest
{
	...
	{
		AddObjective (new ObjectiveProtectArea ("Protect Land", 10));
...
public class QuestRequestOutpost : Quest
{
	...
	{
		AddObjective (new ObjectiveRequestOutpost ("Request Outpost", 10));
...
public class QuestRestoreArea : Quest
{
	...
	{
		AddObjective (new ObjectiveRequestOutpost ("Restore Land", 10));
...
public class QuestFulfillSurvey : Quest
{
	...
	{
		AddObjective (new ObjectiveRequestOutpost ("Fulfill Survey", 10));
...
public class QuestMartenPop : Quest
{
	public QuestMartenPop() : base (QuestConstants.kConservationistNames[5],Player.CharacterClass.Conservationist)
	{
		...
		AddObjective(new ObjectiveIncreaseMartenPop("Increase Habitat",pop,pop+100));
...
public class ObjectiveSurveyArea : ObjectiveStoreInt<int>
{
	...
	public ObjectiveSurveyArea (string name, int goal) : base(name,"LandSurveyed_Count")
	{
...
public class ObjectiveProtectArea : ObjectiveStoreInt<int>
{
	...
	public ObjectiveProtectArea (string name, int goal) : base (name, "LandProtected_Count")
	{
		behaviour = new ObjectiveBehaviour<int>(0, goal, Check, Store);
	}
...
public class ObjectiveRequestOutpost : ObjectiveStoreInt<int>
{
	...
	public ObjectiveRequestOutpost (string name, int goal) : base (name, "OutpostRequested")
	{
		behaviour = new ObjectiveBehaviour<int>(0, goal, Check, Store);
	}
...
public class ObjectiveRestoreArea : ObjectiveStoreInt<int>
{
	...
	public ObjectiveRestoreArea (string name, int goal) : base (name, "LandRestored_Count")
	{
		behaviour = new ObjectiveBehaviour<int>(0, goal, Check, Store);
	}
...
public class ObjectiveFulfillSurvey : ObjectiveStoreInt<int>
{
	...
	public ObjectiveFulfillSurvey (string name, int goal) : base (name, "SurveyRequested_Count")
	{
		behaviour = new ObjectiveBehaviour<int>(0, goal, Check, Store);
	}
...
public class ObjectiveIncreaseMartenPop : ObjectiveStoreInt<WorldData>
{
	...
	public ObjectiveIncreaseMartenPop(string name, int startPop, int goalPop) : base(name,GameManager.kWorldDataChanged)
	{
