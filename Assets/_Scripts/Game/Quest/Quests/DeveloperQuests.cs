...
public class QuestDevelopLand : Quest
{
	...
	{
		AddObjective (new ObjectiveDevelopLand ("Bulldoze", 10));
...
public class QuestBuildHousing : Quest
{
	...
	{
		AddObjective( new ObjectiveBuildHousing("Place Homes", 10));
...
public class QuestOutpostProcess : Quest
{
	...
	{
		AddObjective( new ObjectiveBuildOutpost("Build Outpost", 1));
		AddObjective( new ObjectiveRequestSurveys("Request Surveys", 25));
		AddObjective( new ObjectivePurchaseSurveys("Purchase Surveys", 25));
...
public class QuestHousesAndPop : Quest
{
	...
	{
		AddObjective( new ObjectiveBuildHousing("VacationCentral",50));
		AddObjective( new ObjectiveBuildCapacity("Housing Capacity",1500));
		AddObjective( new ObjectiveTotalPopulation("Big 5,000",5000));
	}
}
...
public class QuestTotalPopulation : Quest
{
	public QuestTotalPopulation() : base (QuestConstants.kDeveloperNames[4], Player.CharacterClass.Developer)
	{
		...
		AddObjective(new ObjectiveIncreaseInitialPopulation("Increase population", startPop, startPop+100));
	}
}
...
public class ObjectiveDevelopLand : ObjectiveStoreInt<int>
{
	...
	public ObjectiveDevelopLand (string name, int goal) : base(name,"LandBulldozed_Count")
	{
...
public class ObjectiveBuildHousing : ObjectiveStoreInt<int>
{
	...
	public ObjectiveBuildHousing( string name, int goal) : base(name,"HousingBuilt_Count")
	{
...
public class ObjectiveBuildCapacity : ObjectiveStoreInt<int>
{
	...
	public ObjectiveBuildCapacity( string name, int goal) : base(name, "HousingBuilt")
	{
		behaviour = new ObjectiveBehaviour<int, int>(0,goal,Check,Store);
		m_description = "Build enough new Housing that will provide space for {0} new residents. \nCurrent Progress: {1}";
	}
	public ObjectiveBuildCapacity( string name, int start, int goal) : base(name, "CapacityChanged")
	{
...
public class ObjectiveTotalPopulation : ObjectiveStoreInt<WorldData>
{
	...
	public ObjectiveTotalPopulation(string name, int goal) : base(name, GameManager.kWorldDataChanged)
	{
...
public class ObjectiveIncreasePopulation : Objective<int,WorldData>
{
	...
	public ObjectiveIncreasePopulation(string name,int startPop, int goalIncrease) : base(name,GameManager.kWorldDataChanged)
	{
...
public class ObjectiveIncreaseInitialPopulation : ObjectiveStoreInt<WorldData>
{
	...
	public ObjectiveIncreaseInitialPopulation(string name, int startPop, int goalPop) : base(name,GameManager.kWorldDataChanged)
	{
...
public class ObjectiveBuildOutpost : ObjectiveStoreInt<int>
{
	...
	public ObjectiveBuildOutpost(string name, int goal) : base(name, "OutpostBuilt_Count")
	{
		behaviour = new ObjectiveBehaviour<int, int>(0,goal,Check,Store);	
	}
	public override string Description {
